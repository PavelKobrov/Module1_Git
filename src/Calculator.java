public class Calculator {
    ...
    public double multiple(int a, String b) {
        return multiple(a, Double.parseDouble(b));
    }

    public double multiple(String a, int b) {
        return multiple(Double.parseDouble(a), b);
    }
    ...
    public double div(int a, String b) {
        return multiple(a, Double.parseDouble(b));
    }

    public double div(String a, int b) {
        return multiple(Double.parseDouble(a), b);
    }
    ...
    public double squared(String a) {
        return squared(Double.parseDouble(a));
    }
    ...
    public double sqrt(String a) {
        return sqrt(Double.parseDouble(a));
    }
    ...
    public double result(int a, int b, String operation) {
        switch (operation) {
            case "sum": {
                return sum(a,b);
            }
